...
\include{estrutura/textuais/desenvolvimento/historico}         			% Revisão de Literatura
\include{estrutura/textuais/desenvolvimento/paradigma}                   % Metodologia
\include{estrutura/textuais/desenvolvimento/caracteristicas}                    % Resultados
\include{estrutura/textuais/desenvolvimento/similares}                   % Capítulo com Orientações de uso do Template
